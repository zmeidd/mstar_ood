...
def test():
    ...
    with torch.no_grad():
        for data, target in test_loader:
            ...
            print(to_np(F.softmax(output, dim=1)))
...
if args.test:
    ...
    np.save("task3oeclass5feature.npy",npfeature)
    exit()
