...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/mutual', help='Folder to save checkpoints.')
...
if args.test:
    ...
    np.save("cifarrandomfeature.npy",npfeature)
