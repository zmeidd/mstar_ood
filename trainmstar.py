...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./snapshots/react', help='Folder to save checkpoints.')
...
if args.dataset == 'cifar10':
    ...
    # num_classes = 10
    temp_transform = trn.Compose([trn.ToTensor()])    # 0~255 --> 0~1

    train_data = dset.ImageFolder('/home/bwang30/study/ann/pytorch_template/download/mstar/oodtrain', temp_transform)
    test_data = dset.ImageFolder('/home/bwang30/study/ann/pytorch_template/download/mstar/oodtest', temp_transform)
