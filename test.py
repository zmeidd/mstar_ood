...
if args.load != '':
    for i in range(1000 - 1, -1, -1):
        ...
        model_name = "/home/bwang30/study/snn/outlier-exposure/CIFAR/snapshots/react/cifar10_allconvreact_baseline_epoch_99.pt"
...
def get_ood_scores(loader, in_dist=False):
    ...
    for batch_idx, (data, target) in enumerate(loader):
        ...
        # w = w.cuda()
        # output = torch.mm(output , w ) + 0.001
        # print(output.shape)
        #output = output / 1000 # temperature scaling
